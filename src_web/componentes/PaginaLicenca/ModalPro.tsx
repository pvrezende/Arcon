...
const ModalPro: React.FC<ModalProProps> = ({ visible, onClose, onAssinar }) => {
  const handleAssinar = () => {
    // Definir plano pro no localStorage
    setUserSubscriptionPlan('PRO');
    
    // Redirecionar para areaprestador com plano pro
    window.location.href = '/areaprestador?plan=pro';
      ...
      <View style={styles.overlay}>
        <View style={styles.modalContainer}>
          ...
          >
            ...
            {/* Título */}
            <Text style={styles.titulo}>Plano Profissional</Text>
            
            {/* Preço */}
            <View style={styles.precoContainer}>
              <Text style={styles.preco}>R$ 49,99</Text>
            ...
            <View style={styles.beneficiosContainer}>
              ...
              {[
                ...
                <View key={index} style={styles.beneficioItem}>
                  <Ionicons name="checkmark-circle" size={20} color="#50b852ff" />
            ...
            <View style={styles.botoesContainer}>
              ...
              <TouchableOpacity style={styles.botaoPrincipal} onPress={handleAssinar}>
                <Text style={styles.textoBotaoPrincipal}>Assinar Pro</Text>
              </TouchableOpacity>
            </View>
