...
const Prestador = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_CONFIG.BACKEND_URL}${API_CONFIG.ENDPOINTS.CADASTRO}`, {
        method: 'POST',
        body: formData
      });
    ...
    >
      ...
      >
        ...
        <View style={styles.botaoVoltarContainer}>
          <TouchableOpacity style={styles.botaoVoltar} onPress={goToLoginPrestador}>
