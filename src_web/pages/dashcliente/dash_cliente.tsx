...
import { MenuClient } from "../../ComponentsClient/Menu";
...
const Dash_cliente: React.FC<DashClienteProps> = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      {/* NAVBAR COM MENU CLIENTE */}
      <Navbar navigation={navigation} customMenu={<MenuClient />} />
          ...
          <View style={[
            ...
            >
              {screenWidth <= 633 ? (
                <>
                  <DashButtonMobile
                    icon={<Ionicons name="snow" size={20} color="#7dd3fc" />}
                    titulo="Comprar Novo"
                  ...
                  />
                  <DashButtonMobile
                    icon={<Ionicons name="construct" size={20} color="#7dd3fc" />}
