...
const Perfil: React.FC<PerfilProps> = ({ navigation }) => {
  ...
  // Função para converter objeto de endereço em string
      ...
      if (storedUser) {
        try {
          ...
          const formattedData: ProfileData = {
            nome: userData.nome || currentUser.displayName || 'Cliente',
            telefone: userData.telefone || currentUser.phoneNumber || '',
            cpf: userData.cpf || '',
